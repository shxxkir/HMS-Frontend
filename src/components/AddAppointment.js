...
function AddAppointment() {
    ...
    return (
        <div className={css.bgr}>
            {<NavBar/>}
            <form className={css.form} onSubmit={addAppointment}>
                <h2 className={css.app}>Book an Appointment</h2>
                ...
                <br/>
                <button className={css.btn} type='submit'>BOOK APPOINTMENT</button>
            </form>
        </div>
    )
}
